...
-- Chèn dữ liệu mẫu vào bảng Collaborator
    ...
    values ('khoadz', 'admin@gmail.com', '$2a$10$7NJakCydtyXhhKWgoJp38e3BCgF3jmK7rP5sk2NxK/lsuwBkBKVAG')
    USE Planny;
GO

-- Insert records into Account table
INSERT INTO [Account] (username, email, sub, password)
VALUES ('user1', 'user1@example.com', 'sub1', 'password1'),
...
VALUES (1, 'user1', 'user1@example.com', 'User One', 'avatar1.png', '1990-01-01', 1, 0),
...
VALUES ('Workspace One', 'ws1', 'http://workspace1.com', 'Description for Workspace One', 1, 1),
...
VALUES ('Board One', 'b1', 'board-one', 'Public', 1, 1),
...
INSERT INTO [Card] (title, description, cover, start_date, due_date, is_completed, short_name, slug_url, is_enabled,
                    list_id)
VALUES ('Card One', 'Description for Card One', 'cover1.png', '2023-01-01', '2023-01-31', 0, 'card-one', 'card-one', 1,
        1),
       ('Card Two', 'Description for Card Two', 'cover2.png', '2023-02-01', '2023-02-28', 0, 'card-two', 'card-two', 1,
        2),
       ('Card Three', 'Description for Card Three', 'cover3.png', '2023-03-01', '2023-03-31', 0, 'card-three',
        'card-three', 1, 3),
       ('Card Four', 'Description for Card Four', 'cover4.png', '2023-04-01', '2023-04-30', 0, 'card-four', 'card-four',
        1, 4),
       ('Card Five', 'Description for Card Five', 'cover5.png', '2023-05-01', '2023-05-31', 0, 'card-five', 'card-five',
        1, 5);
GO

-- Insert records into Collaborator table
INSERT INTO [Collaborator] (role, username, email, fullname, avatar, user_id, workspace_id)
VALUES ('Role One', 'collab1', 'collab1@example.com', 'Collaborator One', 'avatar1.png', 1, 1),
...
VALUES ('Member Role One', 'member1', 'member1@example.com', 'avatar1.png', 'Member One', 1, 1, 1),
